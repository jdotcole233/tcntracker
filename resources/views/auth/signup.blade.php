        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Please provide information below to own an account.</p>
            </div>
          </div>
        </div>
      </div>
               ...
               <meta name="csrf-token" content="{{ csrf_token() }}">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input id="company_name" placeholder="Company Name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="company_name" value="{{ old('name') }}" required autofocus>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input id="email" type="email" placeholder="Email goes here" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2018 <a href="" class="font-weight-bold ml-1" target="_blank">Ton Tracker</a>
          </div>
        </div>
        <div class="col-xl-6">
