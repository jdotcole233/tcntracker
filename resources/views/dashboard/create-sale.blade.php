...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ url('/farmers') }}">Create Sale for {{$farmer->first_name}} {{$farmer->other_name }} {{$farmer->last_name}}</a>
        <!-- Form -->
